...
<li><a href="index.html"><img src="{{ asset('assets/images/clients/clients-2.png') }}" alt=""></a></li>
<li><a href="index.html"><img src="{{ asset('assets/images/clients/clients-3.png') }}" alt=""></a></li>
<li><a href="index.html"><img src="{{ asset('assets/images/clients/clients-4.png') }}" alt=""></a></li>
<li><a href="index.html"><img src="{{ asset('assets/images/clients/clients-5.png') }}" alt=""></a></li>
<li><a href="index.html"><img src="{{ asset('assets/images/clients/clients-6.png') }}" alt=""></a></li>
        ...
        <section class="research-reports-section centred pt_100 pb_90">
            ...
            <div class="auto-container">
                <div class="sec-title light pb_60">
                    ...
                    <p class="text-light mt-3">Discover in-depth analysis and expert insights to make informed investment decisions</p>
                </div>
                <div class="project-tab">
                    ...
                    <div class="p-tabs-content">
                        @foreach($categories as $key => $category)
                            <div class="p-tab {{ $key === 0 ? 'active-tab' : '' }}" id="tab-{{ $category->id }}">
                                <div class="row">
                                    ...
                                    @empty
                                        <div class="col-12">
                                            <p>No research reports available for this category.</p>
                                        </div>
                                    @endforelse
                                </div>
