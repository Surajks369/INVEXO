                    ...
                    <div class="row clearfix">
                        <div class="col-lg-8 col-md-12 col-sm-12 big-column">
                            ...
                            <div class="footer-lower">
                                <figure class="footer-logo"><a href="index.html"><img src="{{ asset('assets/images/logo.jpeg') }}" alt="" style="height:50px;"></a></figure>
                                <ul class="footer-card clearfix">
                                    <li><h4>We Accept:</h4></li>
                                    <li><a href="index.html"><img src="{{ asset('assets/images/icons/card-1.png') }}" alt=""></a></li>
                                    <li><a href="index.html"><img src="{{ asset('assets/images/icons/card-2.png') }}" alt=""></a></li>
                                    <li><a href="index.html"><img src="{{ asset('assets/images/icons/card-3.png') }}" alt=""></a></li>
                                    <li><a href="index.html"><img src="{{ asset('assets/images/icons/card-4.png') }}" alt=""></a></li>
                                    <li><a href="index.html"><img src="{{ asset('assets/images/icons/card-5.png') }}" alt=""></a></li>
                                    <li><a href="index.html"><img src="{{ asset('assets/images/icons/card-6.png') }}" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget logo-widget centred ml_80">
                                <div class="widget-content">
                                    <figure class="footer-logo mb_15"><a href="index.html"><img src="{{ asset('assets/images/logo-3.png') }}" alt=""></a></figure>
                                    ...
                                    <ul class="download-list clearfix">
                                        ...
                                        <li><a href="index.html"><img src="{{ asset('assets/images/icons/icon-2.png') }}" alt=""></a></li>
